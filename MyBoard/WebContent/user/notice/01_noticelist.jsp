	...
	<div align="center">
		<table width="700" border="1" bgcolor="powderblue">
			<tr height="40">
				...
				<!-- id가 관리자일 때 
				<button onclick="location.href='mg/notice/noticeMain_mg.jsp'">공지사항 메인</button>
				<button onclick="location.href='mg/notice/02_noticewrite.jsp'">글쓰기</button></td>
				-->
				<button onclick="location.href='user/notice/noticeMain.jsp'">공지사항 메인</button>
			</tr>
